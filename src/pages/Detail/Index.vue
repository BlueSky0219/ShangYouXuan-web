          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSale, index) in spuSaleAttrList" :key="index">
                ...
                <dd @click="changeActive(color, spuSale.spuSaleAttrValueList)" changepirce="0"
                  :class="{ active: color.isChecked == 1 }" v-for="(color, colorId) in spuSale.spuSaleAttrValueList"
                  :key="colorId">{{ color.saleAttrValueName }}
                </dd>
              </dl>
            </div>
            <div class="cartWrap">
...
export default {
  ...
  methods: {
    changeActive(color, spuSaleAttrValueList) {
